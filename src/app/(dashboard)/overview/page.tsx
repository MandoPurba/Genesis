...
import { ArrowDown, ArrowUp, BarChart, Banknote, Users, Fingerprint, MoveRight, PlusCircle } from "lucide-react"
  ...
  return (
    <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
      ...
      <Card className="bg-primary text-primary-foreground">
        <CardHeader>
          <CardDescription className="text-primary-foreground/80">Net Balance</CardDescription>
          <CardTitle className="flex items-baseline gap-2">
            <span>Rp 7.106.660</span>
          ...
          <div className="flex justify-between items-center text-sm">
              <div className="font-semibold">
               ...
               <div className="font-semibold">
                  ...
                  <p className="flex items-center gap-1">Rp 7.106.660 <span className="text-destructive flex items-center text-xs"><ArrowDown className="h-3 w-3"/>-4.75%</span></p>
              </div>
          </div>
          <div data-ai-hint="line chart" className="h-[200px] w-full bg-muted/30 rounded-md flex items-end p-2">
      ...
      <Card className="md:col-span-1 lg:col-span-1">
          <CardHeader>
              ...
              <p className="text-2xl font-bold pt-2">Rp 8.125.230</p>
      ...
      <Card className="md:col-span-1 lg:col-span-1 row-start-3">
          <CardHeader>
              <CardTitle>Profile</CardTitle>
          </CardHeader>
          <CardContent className="text-center">
              <Image src="https://placehold.co/100x100.png" data-ai-hint="person" alt="User Avatar" width={80} height={80} className="rounded-full mx-auto" />
              <p className="font-semibold mt-4">Carlic Bolomboy</p>
              <p className="text-sm text-muted-foreground">carlic@gmail.com</p>
      ...
      <Card className="md:col-span-2 lg:col-span-2">
        ...
        <CardContent className="grid md:grid-cols-2 gap-6">
            ...
            <div className="relative h-[188px] w-[300px]">
